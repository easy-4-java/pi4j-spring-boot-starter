...
**Spring Boot Starter for pi4j**

[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/pi4j-spring-boot-starter)](https://github.com/easy-4-java/pi4j-spring-boot-starter)
...
> **Artifact ID**：`pi4j-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**pi4j-spring-boot-starter** is a Spring Boot starter that integrates **pi4j** for applications using pi4j. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume pi4j capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using pi4j |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for pi4j |
| JDK | `17` |
| Coordinates | `io.github.easy4j:pi4j-spring-boot-starter:3.0.x.20260527-SNAPSHOT` |
| Config Prefix | `pi4j` |
...
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers pi4j beans automatically |
| Property Binding | ✅ Stable | Binds `pi4j.*` to `Pi4jProperties` |
| `Pi4jTemplate` bean | ✅ Stable | Auto-registered via Pi4jAutoConfiguration |
...
|---|---|---|
| `Pi4jTemplate` | classpath + property | not created |
...
```java
@Autowired
private Pi4jTemplate openCVFaceRecognitionTemplate;
```
...
|---|---|---|:---:|---|:---:|
| `pi4j.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl pi4j-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `pi4j.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/pi4j-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/pi4j-spring-boot-starter)
